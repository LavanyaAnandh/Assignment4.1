...
public class TvSurveyTask1 {	
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		job.setJarByClass(TvSurveyTask1.class);
		...
		job.setMapperClass(TvSurveyTask1Mapper.class);
		job.setReducerClass(TvSurveyTask1Reducer.class);
		
		//Setting final output key and value class from reucer.
