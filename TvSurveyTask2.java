...
public class TvSurveyTask2 {	
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		job.setJarByClass(TvSurveyTask2.class);
		...
		job.setMapperClass(TvSurveyTask2Mapper.class);
		job.setReducerClass(TvSurveyTask2Reducer.class);
		//job.setCombinerClass(TvSurveyTask1Reducer.class);
